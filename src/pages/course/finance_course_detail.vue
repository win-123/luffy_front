<template>
  <main class="wrap">
    <div class="course-finance-banner" style="display: flex;">
      <div class="course-finance-main">
        <h1 class="course-sec-tit" style="font-size: 64px;color: #FFFFFF;letter-spacing: 2.66px;">{{course.name}}</h1>
        <span class="finance-course-add" style="display: block;">{{course.course_slogan}}</span>
        <img @click="this.video_layer=true;" src="../../assets/img/banner-play-white.png" style="cursor: pointer; display: block; margin: 47px auto 46px;" width="65" height="65" alt="">
        <ul style="padding: 0; margin: 0 0 0 178px; display: flex; align-items: center;">
          <li class="mysql-detail-item" style="padding: 0 40px 0 0;">
            难度：{{course.level}}
          </li>
          <li style="width: 1px; height: 26px; border-left: 1px solid #fff;"></li>
          <li class="mysql-detail-item">
            时长：{{course.hours}}小时
          </li>
          <li style="width: 1px; height: 26px; border-left: 1px solid #fff;"></li>
          <li class="mysql-detail-item">
          ...
          <li v-show="course.course_review!=''" style="width: 1px; height: 26px; border-left: 1px solid #fff;"></li>
          <li v-show="course.course_review!=''" class="mysql-detail-item" style="border-right: none;">
...
<script>
  ...
  import courseIntroduce from 'src/pages/course/children/finance_introduce.vue';
...
<style scoped>
  ...
  .course-finance-banner {
    width: 100%;
    height: 597px;
    background: url("../../assets/img/finance-banner.png") no-repeat;
