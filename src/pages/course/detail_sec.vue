<template>
  <main class="wrap">
    <div class="django-course-banner" style="display: flex;">
      <div class="django-course-main">
        <div @click="this.video_layer=true;" style="display: flex; align-items: center;">
          ...
          <h1 class="course-sec-tit">{{course.type}}{{course.name}}</h1>
        </div>
...
<script>
  ...
  import courseIntroduce from 'src/pages/course/children/course_introduce_sec.vue';
...
<style scoped>
  ...
  .django-course-banner {
    width: 100%;
    height: 579px;
    background: url("../../assets/img/djiago.png") no-repeat;
