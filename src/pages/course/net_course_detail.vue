<template>
  <main class="wrap">
    <div class="net-course-banner" style="display: flex;">
      <div class="net-course-main">
        <div style="width: 764px; margin-top: 109px;">
          <div @click="this.video_layer=true;" style="display: flex; align-items: center;">
            <img src="../../assets/img/banner-play.png" style="cursor: pointer;" width="56" height="56" alt="">
            <h1 class="course-sec-tit" style="width: 664px; font-size: 39px;color: #4A4A4A;letter-spacing: 0.3px;">{{course.name}}</h1>
          </div>
          <span class="course-add">{{course.course_slogan}}</span>
          <ul style="padding: 0; margin-top: 99px; display: flex; align-items: center; justify-content: flex-start;">
            <li class="sec-detail-item" style="padding: 0 20px 0 0;">
              难度：{{course.level}}
            </li>
            <li style="width: 2px; height: 14px; border-left: 1px solid #979797;"></li>
            <li class="sec-detail-item">
              时长：{{course.hours}}小时
            </li>
            <li style="width: 2px; height: 14px; border-left: 1px solid #979797;"></li>
            <li class="sec-detail-item">
            ...
            <li v-show="course.course_review!=''" style="width: 2px; height: 14px; border-left: 1px solid #979797;"></li>
            <li v-show="course.course_review!=''" class="sec-detail-item" style="border-right: none;">
        ...
        <div style="position: relative; top: -397px; left: 763px;">
          <img src="../../assets/img/net-course-banner.png" width="544" height="479" alt="">
        </div>
      </div>
    </div>
...
<script>
  ...
  import courseIntroduce from 'src/pages/course/children/net_course_introduce.vue';
