<template>
  <main class="wrap">
    <div class="course-mysql-banner" style="display: flex;">
      <div class="course-mysql-main">
        <h1 class="course-sec-tit" style="font-size: 64px;color: #4A4A4A;letter-spacing: 2.66px;">{{course.name}}</h1>
        <span class="mysql-course-add" style="display: block;">{{course.course_slogan}}</span>
        <img @click="this.video_layer=true;" src="../../assets/img/banner-play.png" style="cursor: pointer; display: block; margin: 28px auto 45px;" width="65" height="65" alt="">
        <div style="width: 100%; display: flex; justify-content: center; align-items: center;">
          <ul style="padding: 0; margin: 0; display: flex; align-items: center;">
            ...
            <li style="width: 1px; height: 26px; border-left: 1px solid #4A4A4A;"></li>
            ...
            <li v-show="course.course_review!=''" style="width: 1px; height: 26px; border-left: 1px solid #4A4A4A;"></li>
...
<script>
  ...
  import courseIntroduce from 'src/pages/course/children/mysql_course_introduce.vue';
...
<style scoped>
  ...
  .course-mysql-banner {
    width: 100%;
    height: 597px;
    background: url("../../assets/img/mysql-banner.png") no-repeat;
