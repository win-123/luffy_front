<template>
  <div style="width: 100%;">
    <div style="width: 1200px; margin: 0 auto;">
      <div style="width: 1145px; margin: 80px auto 90px;">
        <div style="display: flex; text-align: left; ">
          <div style="text-align: left;">
            <h3 class="sec-item-tit pad">课程概述</h3>
            <em style="width: 46px; border-top: 2px solid #78C63F; margin: 18px 0 31px;"></em>
            <p class="sec-cont-dec finance-cont-right" style="width: 500px; height: 150px; overflow: hidden;">
              {{course_brief.brief}}
            </p>
          </div>
          <div style="margin-left: 130px; width: 326px; padding-left: 22px; border-top: 5px solid #84CC39; padding-top: 39px; height: 290px; background: #FFFFFF; box-shadow: 0 4px 8px 0 #E8E8E8; border-radius: 4px;">
            <span style="font-size: 24px; color: #4A4A4A; letter-spacing: 3.14px; display: block;">IEEE 2017年编程排名</span>
            <span style="font-size: 18px; color: #4A4A4A; letter-spacing: 2.36px; display: block; margin-top: 14px;">NO.1</span>
            <span style="font-size: 18px; color: #4A4A4A; letter-spacing: 2.36px; display: block; margin-top: 13px;">Python相关职位薪酬</span>
            <span style="font-size: 18px; color: #4A4A4A; letter-spacing: 2.36px; display: block; margin-top: 14px;">80%起薪10K+</span>
            <span style="font-size: 12px; color: #4A4A4A; letter-spacing: 1.57px; display: block; margin-top: 38px;">来自IEEE SPECTRUM和拉勾网的公开数据</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div style="width: 100%; padding-top: 90px;">
      <div style="width: 1200px; margin: 0 auto; display: flex;">
        <div>
          <img src="../../../assets/img/python-left.png" width="496" height="504" alt="">
        </div>
        <div style="width: 496px; margin-top: 28px; margin-left: 131px; text-align: left;">
          <h3 class="computer-why-tit">为什么学习这门课程</h3>
      ...
      <div style="width: 1200px; margin: 0 auto; display: flex; padding-bottom: 133px;">
        <div style="width: 464px; margin-top: 17px;text-align: left;">
          <h3 class="computer-why-tit">你将获得的服务</h3>
        ...
        <div style="margin-left: 149px;">
          <img src="../../../assets/img/python-right.png" width="404" height="306" alt="">
        </div>
      </div>
    </div>
    ...
    <div style="width: 100%; background: #FAFAFA; padding-top: 75px; padding-bottom: 60px;">
      <h4 style="font-size: 24px;color: #4A4A4A;letter-spacing: 0.69px;margin: 0;text-align:center;padding-bottom: 20px;">课程讲师简介</h4>
      ...
      <ul style="width: 1200px;margin: 0 auto; display: flex; justify-content: space-between;padding: 0 265px;">
        <li v-for="item in course_brief.teachersinfo" id="{{item.teacherid}}" style="width: 316px; border-top: 4px solid #4A4A4A; height: 408px; text-align: center; background: #FFFFFF;box-shadow: 0 4px 8px 0 #E8E8E8;border-radius: 4px;">
          ...
          <p style="width: 236px; text-align: left; margin: 22px auto 0;font-size: 12px;color: #4A4A4A;letter-spacing: 0.55px;line-height: 22px;">
            {{item.teacherbrief}}
          </p>
        </li>
      </ul>
