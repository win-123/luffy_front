  ...
  <div style="width: 100%;">
    <div style="width: 100%; padding-top: 90px; padding-bottom: 82px;">
      <div style="width: 1200px; margin: 0 auto; display: flex;">
        <div style="width: 500px; text-align: left;">
          <h3 class="computer-why-tit">课程概述</h3>
        ...
        <div style="margin-left: 130px; ">
          <img src="../../../assets/img/linux-img1.png" width="563" height="376" alt="">
        </div>
      </div>
    </div>
    ...
    <div style="width: 100%; padding-top: 120px;">
      <div style="width: 1200px; margin: 0 auto; display: flex;">
        <div style="margin-top: 49px;">
          <img src="../../../assets/img/linux-img2.png" width="490" height="329" alt="">
        </div>
      ...
      <div style="width: 1200px; margin: 159px auto 0; display: flex; padding-bottom: 133px;">
        ...
        <div style="margin-left: 170px;">
          <img src="../../../assets/img/linux-img3.png" width="488" height="324" alt="">
        </div>
      </div>
    </div>
    <div class="" style="background: #F7F7F7; width: 100%; ">
      <div style="width: 1281px; margin: 0 auto; text-align: left;">
        <h4 class="sec-item-title web-item-title">我将学到哪些内容？</h4>
    ...
    <div style="padding-bottom: 100px; width: 1200px; text-align: left; margin: 0 auto;">
      ...
      <div style="display: flex;">
        <p style="width: 100%; height: 112px;font-size: 16px;color: #333333;letter-spacing: 1.28px;line-height: 28px;">
    ...
    <div style="width: 100%; background: #FAFAFA; padding-top: 120px; padding-bottom: 120px;">
      <h4 style="font-size: 24px; color: #4A4A4A; letter-spacing: 0.69px;margin: 0;">课程讲师简介</h4>
      <em style="width: 63px; border-top: 2px solid #7ED321;  margin: 30px auto 60px;"></em>
      <ul style="width: 100%; margin: 0 auto; display: flex; justify-content: center;">
        <li v-for="item in course_brief.teachersinfo" id="{{item.teacherid}}" style="width: 316px; border-top: 4px solid #4A4A4A; height: 408px; margin-right: 46px; text-align: center; background: #FFFFFF;box-shadow: 0 4px 8px 0 #E8E8E8;border-radius: 4px;">
