...
<div style="width: 100%;">
  <div style="width: 1200px; margin: 0 auto;">
    <div style="text-align: center;">
      ...
      <div style="margin-top: 66px;">
        ...
        <div v-show="!course_brief.is_online" style="display: flex; justify-content: center; align-items: center; margin-top: 66px;">
          <button  @click="online_remind" class="charge-btn-fir charge-btn-active" style="margin-right: 48px;">开课时通知我</button>
        </div>
        <div v-show="course_brief.is_online" style="display: flex; justify-content: center; align-items: center; margin-top: 66px;">
          <button @click="buy()" class="charge-btn-fir charge-btn-active" style="margin-right: 48px;">购买111</button>
    ...
    <div style="width: 1145px; margin: 150px auto 0;">
      <div style="display: flex; text-align: left; ">
        <div style="text-align: left;">
          <h3 class="sec-item-tit pad">课程概述</h3>
          <em style="width: 46px; border-top: 2px solid #78C63F; margin: 18px 0 31px;"></em>
          <p class="sec-cont-dec sec-cont-left">
            {{course_brief.brief}}
          </p>
        </div>
        <img style="margin-top: 18px; margin-left: -40px;  position: relative; z-index: -1;" src="../../../assets/img/djiago-couse-right.png" width="682" height="382" alt="">
      </div>
      <div style="text-align: right;">
        <div style="display: flex;">
          <img style="margin-top: -30px;" src="../../../assets/img/course-sec-left.png" width="543" height="357" alt="">
          <div style="text-align: left; margin-left: 59px; margin-top: 94px;">
            <h3 class="sec-item-tit">为什么学习这门课程</h3>
            <div style="display: flex;">
              <em style="width: 46px; border-top: 2px solid #78C63F; margin: 18px 0 31px;"></em>
            </div>
            <p class="sec-cont-dec sec-cont-right">
  ...
  <div style="width: 100%; margin-top: 120px; background: #333333; padding-top: 77px;">
    <h3 class="course-sec-service-tit">您将获得的服务</h3>
    <ul style="display:flex; align-items: center; justify-content: space-between; padding-top: 79px; width: 1200px; margin: 0 auto; padding-left: 0; padding-bottom: 140px;">
      <li style="width: 187px;">
        <div style="display: flex; align-items: center;justify-content: center;">
          <span class="sec-service-num">1</span>
          <span class="sec-service-tit">精彩内容</span>
        </div>
        <p class="sec-service-dec" style="width: 100%; text-align: center; height: 34px;">知名网红讲师根据企业真实需求精心打造的课程内容</p>
      </li>
      <li style="width: 187px;">
        <div style="display: flex; align-items: center;justify-content: center;">
          <span class="sec-service-num">2</span>
          <span class="sec-service-tit">资料下载</span>
        </div>
        <p class="sec-service-dec" style="width: 100%; text-align: center; height: 34px;">全部课件、笔记、案例下载</p>
      </li>
      <li style="width: 187px;">
        <div style="display: flex; align-items: center;justify-content: center;">
          <span class="sec-service-num">3</span>
          <span class="sec-service-tit">获得伙伴</span>
        </div>
        <p class="sec-service-dec" style="width: 100%; text-align: center; height: 34px;">加入学习群，<br>
          和众多小伙伴一起学习</p>
      </li>
      <li style="width: 187px;">
        <div style="display: flex; align-items: center;justify-content: center;">
          <span class="sec-service-num">4</span>
          <span class="sec-service-tit">老师解答</span>
        </div>
        <p class="sec-service-dec" style="width: 100%; text-align: center; height: 34px;">群导师答疑，<br>
          减少自学走弯路时间</p>
      </li>
      <li style="width: 187px;">
        <div style="display: flex; align-items: center;justify-content: center;">
          <span class="sec-service-num">5</span>
          <span class="sec-service-tit">对话ALEX</span>
        </div>
        <p class="sec-service-dec" style="width: 100%; text-align: center; height: 34px;">Alex老师精心熬制的心灵洗脑鸡汤，帮你拨云见日看清人生路</p>
      </li>
    </ul>
  </div>
  <div class="" style="background: #F7F7F7; width: 100%; ">
    <div style="width: 1281px; margin: 0 auto; text-align: center">
      <h4 class="sec-item-title" style="font-size:24px;margin:0;">我将学到哪些内容？</h4>
      <p class="sec-study-cont-dec">
        {{course_brief.what_to_study_brief}}
      </p>
      <em style="width: 63px; border-top: 2px solid #78C63F;  margin: 30px auto 47px;"></em>
      ...
      <li style="list-style: none; width: 272px;">
        ...
        <div>
          ...
          <ul style="padding-left: 20px; margin-top: 10px;">
            ...
            <!--<li  class="has-list-style" style="list-style: disc;">-->
              <!--<a class="how-help-need-spec" v-link="{name:'mysql-course-detail',params:{id:4}}" id="4" href="#">Mysql数据库从入门至进阶</a>-->
            <!--</li>-->
            <!--<li  class="has-list-style" style="list-style: disc;">-->
              <!--<a class="how-help-need-spec" v-link="{name:'python-course-detail',params:{id:5}}" id="5" href="#">Python开发21天入门必备</a>-->
            <!--</li>-->
            <!--<li  class="has-list-style" style="list-style: disc;">-->
              <!--<a class="how-help-need-spec" v-link="{name:'web-course-detail',params:{id:8}}" id="8" href="#">Web开发入门</a>-->
            <!--</li>-->
          </ul>
        </div>
      </li>
