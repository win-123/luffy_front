  ...
  <div style="width: 100%;">
    <div style="width: 1200px; margin: 0 auto;">
      ...
      <div style="width: 1145px; margin: 150px auto 0;">
        <div style="display: flex; text-align: left; ">
          ...
          <img style="margin-top: 18px; margin-left: -40px;  position: relative; z-index: -1;" src="../../../assets/img/net-course-right.png" width="682" height="382" alt="">
        </div>
        <div style="text-align: right;">
          <div style="display: flex;">
            <img style="margin-top: -30px;" src="../../../assets/img/net-course-left.png" width="543" height="357" alt="">
    ...
    <div class="" style="background: #F7F7F7; width: 100%; ">
      <div style="width: 1281px; margin: 0 auto; text-align: center">
        <h4 class="sec-item-title" style="margin:0;">我将学到哪些内容？</h4>
        ...
        <div style="display: flex; flex-wrap: wrap; padding-bottom: 60px;">
          <div v-for="(index,item) in course_brief.courseoutline" style="width: 379px; text-align: left; height: 466px; margin-right: 48px; background: #FFFFFF; margin-bottom: 60px; box-shadow: 0 4px 9px 0 #E9E9E9;">
            ...
            <div style="width: 319px; height: 346px; overflow: hidden; margin: 0 auto; text-align: left;">
              ...
              <pre class="project-req" style="height: 312px; overflow: hidden;" v-html="item.outline_content"></pre>
            </div>
          </div>
        </div>
      </div>
    ...
    <div style="width: 100%; background: #FAFAFA; padding-top: 75px; padding-bottom: 60px;">
      <h4 style="font-size: 24px;color: #4a4a4a;margin-bottom:20px;text-align:center;">课程讲师简介</h4>
