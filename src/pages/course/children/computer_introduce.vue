<template>
  <div style="width: 100%;">
    <div style="width: 1200px; margin: 0 auto;">
      <div style="width: 1145px; margin: 49px auto 90px;">
        <div style="display: flex; text-align: left;">
          <div style="text-align: left; margin-top: 41px;">
            <h3 class="sec-item-tit pad">课程概述</h3>
            <em style="width: 46px; border-top: 2px solid #52CEB0; margin: 18px 0 31px;"></em>
            <p class="sec-cont-dec computer-brief">
              {{course_brief.brief}}
            </p>
          </div>
          <img style="margin-left: 142px;" src="../../../assets/img/computer-right.png" width="471" height="397" alt="">
        </div>
      </div>
    </div>
    <div style="text-align: center; background: #FAFBFC; padding-bottom: 90px;">
    ...
    <div style="width: 100%; padding-top: 102px;">
      <div style="width: 1200px; margin: 0 auto; display: flex;">
        <ul class="computer-icon-list">
          <li class="computer-icon-item">
            <img style="margin-top: 17px;" src="../../../assets/img/computer-icon1.png" width="87" height="82" alt="">
            <span style="display: block; margin-top: 8px; font-size: 12px;color: #9D9D9D;">作用及关系</span>
          </li>
          <li class="computer-icon-item">
            <img style="margin-top: 17px;" src="../../../assets/img/computer-icon2.png" width="87" height="82" alt="">
            <span style="display: block; margin-top: 8px; font-size: 12px;color: #9D9D9D;">系统演变史</span>
          </li>
          <li class="computer-icon-item">
            <img style="margin-top: 17px;" src="../../../assets/img/computer-icon3.png" width="87" height="82" alt="">
            <span style="display: block; margin-top: 8px; font-size: 12px;color: #9D9D9D;">计算机语言</span>
          </li>
          <li class="computer-icon-item">
            <img style="margin-top: 17px;" src="../../../assets/img/computer-icon4.png" width="87" height="82" alt="">
            <span style="display: block; margin-top: 8px; font-size: 12px;color: #9D9D9D;">TCP／IP／OSI</span>
          </li>
          <li class="computer-icon-item">
            <img style="margin-top: 17px;" src="../../../assets/img/computer-icon3.png" width="87" height="82" alt="">
            <span style="display: block; margin-top: 8px; font-size: 12px;color: #9D9D9D;">计算机语言</span>
        ...
        <div style="width: 496px; margin-top: 28px; margin-left: 207px; text-align: left;">
          <h3 class="computer-why-tit">为什么学习这门课程</h3>
          <em style="width: 46px; border-top: 2px solid #15BC95; margin: 34px 0 47px;"></em>
          <p class="sec-project-req" style="width: 100%; height:330px;font-size: 14px;color: #4A4A4A;letter-spacing: 1.83px;line-height: 30px;">
            {{course_brief.why_study}}
          </p>
        </div>
      </div>
      <div style="width: 1200px; margin: 0 auto; display: flex; padding-bottom: 60px;">
        ...
        <div style="margin-left: 162px; margin-top: -20px;">
          <img src="../../../assets/img/computer-icon-group.png" width="418" height="411" alt="">
        </div>
      </div>
    </div>
    <div class="" style="background: #F7F7F7; width: 100%; ">
      <div style="width: 1281px; margin: 0 auto; text-align: center">
        ...
        <em style="width: 63px; border-top: 2px solid #52CEB0;  margin: 30px auto 50px;"></em>
        <div style="display: flex; flex-wrap: wrap; padding-bottom: 60px;">
          <div v-for="(index,item) in course_brief.courseoutline" style="width: 379px; text-align: left; height: 466px; margin-right: 48px; background: #FFFFFF; margin-bottom: 60px; box-shadow: 0 4px 9px 0 #E9E9E9;">
            <span class="computer-project-icon">PROJECT {{index+1}}</span>
    ...
    <div style="padding-bottom: 100px; width: 1200px; text-align: left; margin: 0 auto;">
      ...
      <em style="width: 63px; border-top: 2px solid #52CEB0; margin: 30px 0 43px;"></em>
    ...
    <div style="width: 100%; background: #FAFAFA; padding-top: 75px; padding-bottom: 60px;">
      <h4 style="width:100%;font-size: 24px;color: #4A4A4A;text-align:center;margin-bottom: 20px;">课程讲师简介</h4>
