<template>
  <div style="width: 100%;">
    <div style="width: 1200px; margin: 0 auto;">
      ...
      <div style="width: 1145px; margin: 150px auto 0;">
        <div style="display: flex; text-align: left; ">
          ...
          <img style="margin-top: 18px; margin-left: -40px;  position: relative; z-index: -1;" src="../../../assets/img/mysql-right.png" width="682" height="382" alt="">
        </div>
        <div style="text-align: right;">
          <div style="display: flex;">
            <img style="margin-top: -30px;" src="../../../assets/img/mysql-left.png" width="543" height="357" alt="">
          ...
          <div>
            ...
            <ul style="padding-left: 20px; margin-top: 10px;">
              ...
              <!--<li  class="has-list-style" style="list-style: disc;">-->
                <!--<a class="how-help-need-spec"  id=5 v-link="{name:'python-course-detail',params:{id:5}}" href="#" >Python开发21天入门必备</a></li>-->
    ...
    <div style="width: 100%; background: #FAFAFA; padding-top: 75px; padding-bottom: 60px;">
      <h4 style="font-size: 24px;color: #4a4a4a;margin-bottom:20px;">课程讲师简介</h4>
