  ...
  <main class="wrap">
    <div class="course-algorithm-banner" style="display: flex;">
      <div style=" width: 1200px; margin: 0 auto;">
        <div class="course-algorithm-main">
          <div style="width: 100%; display: flex;">
            <img src="../../assets/img/candle-left.png" style="justify-content: flex-start; margin-left: 15px;" width="112" height="88" alt="">
            <div @click="this.video_layer=true;" style="display: flex; width: 610px; justify-content: center; margin-top: 52px;">
              <img src="../../assets/img/banner-play.png" style="cursor: pointer;" width="45" height="45" alt="">
              <h1 style="font-size: 36px; margin-left: 16px; color: #4A4A4A;letter-spacing: 1.49px;">{{course.name}}</h1>
            </div>
            <img src="../../assets/img/candle-right.png" style="justify-content: flex-end; margin-right: 9px;" width="112" height="88" alt="">
          </div>
          <span style="display: block; margin-top: 26px; font-size: 18px;color: #4A4A4A;letter-spacing: 0.75px;">{{course.course_slogan}}</span>
  ...
  <div v-show="video_layer" @click="this.video_layer=false;" class="video-shadow">
    <div class="course-introduce-video">
      <object id="{{'cc_'+vid}}" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="1200" height="676" >
        ...
        <embed :src="'https://p.bokecc.com/flash/single/D90C6BABEBFD8C03_'+vid+'_false_94B724260B49E936_1/player.swf'" width="100%" height="" name="{{'cc_'+vid}}" allowFullScreen="true" wmode="transparent" allowScriptAccess="always" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"/>
      </object>
    </div>
  </div>
</template>
<script>
  ...
  import courseIntroduce from 'src/pages/course/children/algorithm_introduce.vue';
...
<style scoped>
  ...
  .course-algorithm-banner {
    width: 100%;
    height: 597px;
    background: url("../../assets/img/algorithm-banner.png") no-repeat;
    background-size: 100% auto;
    text-align: center;
  }
  .course-algorithm-main {
    width: 878px;
    height: 280px;
    margin: 169px auto 0;
