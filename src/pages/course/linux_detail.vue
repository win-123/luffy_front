<template>
  <main class="wrap">
    <div class="linux-course-banner" style="display: flex;">
      <div class="linux-banner-text">
        <div  style="display: flex; align-items: center;">
          <h1 class="linux-course-sec-tit">{{course.name}}</h1>
        </div>
        ...
        <div @click="this.video_layer=true;" class="linux-play-icon">
          <img src="../../assets/img/linux-play.png" width="56" height="56" alt="">
        </div>
      </div>
    </div>
...
<script>
  ...
  import courseIntroduce from 'src/pages/course/children/linux_introduce.vue';
...
<style scoped>
  ...
  .linux-course-banner {
    width: 100%;
    height: 597px;
    background: url("../../assets/img/linux-banner.png") no-repeat;
  ...
  @media screen and (min-width: 1800px) {
    .linux-course-banner {
      height: 800px;
      background: url("../../assets/img/linux-banner.png") no-repeat 0 -160px;
