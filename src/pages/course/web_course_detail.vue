<template>
  <main class="wrap">
    <div class="web-course-banner" style="display: flex;">
      <div style="width: 1200px; margin: 182px auto 0; text-align: left;">
        <div @click="this.video_layer=true;" style="display: flex; align-items: center;">
          ...
          <h1 class="course-sec-tit">{{course.name}}</h1>
        </div>
        <span class="course-add" style="width: 464px;">{{course.course_slogan}}</span>
        <div style="width: 100%; display: flex; align-items: center;">
          <ul style="padding: 0; margin-top: 63px; display: flex; align-items: center; justify-content: flex-start;">
...
<script>
  ...
  import courseIntroduce from 'src/pages/course/children/web_introduce.vue';
...
<style scoped>
  ...
  .web-course-banner {
    width: 100%;
    height: 597px;
    background: url("../../assets/img/web-banner.png") no-repeat;
