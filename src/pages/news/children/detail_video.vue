    ...
    <div style="width: 834px; margin-right: 30px;">
      ...
      <div style="margin-top: 18px; margin-bottom: 30px; display: flex; align-items: center;">
        ...
        <div class="arc-time view-num love">
          ...
          收藏<span style="display:inline-block; margin-left: 8px;">{{article.collect_num}}</span></div>
      ...
      <div class="arc-content">
        ...
        <div class="main-cont" >
          <object id="{{'cc_'+vid}}" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="1200" height="676" >
            ...
            <embed :src="'https://p.bokecc.com/flash/single/D90C6BABEBFD8C03_'+vid+'_false_94B724260B49E936_1/player.swf'" width="100%" height="473px" name="{{'cc_'+vid}}" allowFullScreen="true" wmode="transparent" allowScriptAccess="always" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"/>
          </object>
                ...
                <div style="margin-left: 21px; width: 755px;">
                  ...
                  <div style="display: flex; margin-top: 16px;">
                    ...
                    <div style="display: flex; align-items: center; margin-left: auto;">
                      <div style="cursor: pointer; display: flex; align-items: center; font-size: 12px; color: #999999;">
                        <i class="fa fa-thumbs-o-up" aria-hidden="true"></i>
                        <span style="display: inline-block; margin-left: 5px;">{{com.agree_number}}</span>
                      </div>
                      <div style="cursor: pointer; display: flex; align-items: center; margin-left: 30px; font-size: 12px; color: #999999;">
                ...
                <div v-for="(item,rep) in com.child" id="{{rep.id}}" class="play-ques-item answer-list">
                  <div class="play-reply" style="display: flex;">
                    <div style="width: 38px; height: 38px; border-radius: 38px; overflow: hidden;">
                      <img :src="rep.userinfo.head_img" width="100%" alt="">
                    </div>
  ...
  export default {
    data() {
      return {
        ...
        article: '',
        ccplayer: '',
        vid:'EABD789263F9CC769C33DC5901307461',
        newsComments:'',
        comment_input:false,
...
//      CC验证
      get_cc_verification_code: function(vid) {
